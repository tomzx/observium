...
if ($device['os'] == "deltaups")
{
  ...
  $dupsCurrent = array(
    ...
    array('OID' => "1.3.6.1.4.1.2254.2.4.5.5.0",
          'descr' => "Output",
          'divisor' => 10
         ),
    array('OID' => "1.3.6.1.4.1.2254.2.4.4.4.0",
          'descr' => "Input",
          'divisor' => 10
         ),
    array('OID' => "1.3.6.1.4.1.2254.2.4.6.4.0",
          'descr' => "Bypass",
          'divisor' => 10
         )
  );

  foreach ($dupsCurrent as $eachArray => $eachValue)
  {
    ...
    if($current != "NULL" )
    {
        discover_sensor($valid['sensor'], 'current', $device, $eachValue['OID'], $index, "DeltaUPS", $eachValue['descr'], $eachValue['divisor'], '1', NULL, NULL, NULL, NULL, $current);
    }
  }
}
