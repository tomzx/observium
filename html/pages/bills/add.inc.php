...
if ($_SESSION['userlevel'] == "10") {
  if (is_numeric($vars['port'])) {
    ...
    echo("  <li><a href=\"#ports\" data-toggle=\"tab\">Ports</a></li>\n");
  }
...
<?php
  ...
  if(is_array($port)) {
    ...
    echo("  <fieldset class=\"tab-pane fade\" id=\"ports\">\n");
...
?>
  <fieldset class="tab-pane fade active in" id="properties">
...
?>
  ...
  <fieldset class="tab-pane fade" id="optional">
