...
$links['quick']    = ($isUser ? generate_url($vars, array('view' => 'quick')) : "javascript:;");
$links['accurate'] = ($isUser ? generate_url($vars, array('view' => 'accurate')) : "javascript:;");
$links['transfer'] = ($isUser ? generate_url($vars, array('view' => 'transfer')) : "javascript:;");
$links['history']  = ($isUser ? generate_url($vars, array('view' => 'history')) : "javascript:;");
$links['api']      = ($isAdmin ? generate_url($vars, array('view' => 'api')) : "javascript:;");
$links['edit']     = ($isAdmin ? generate_url($vars, array('view' => 'edit')) : "javascript:;");
$links['delete']   = ($isAdmin ? generate_url($vars, array('view' => 'delete')) : "javascript:;");
$links['reset']    = ($isAdmin ? generate_url($vars, array('view' => 'reset')) : "javascript:;");
